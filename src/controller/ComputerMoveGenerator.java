...
public class ComputerMoveGenerator{
    Data data;
    public ComputerMoveGenerator(Data data)
    {
        this.data=data;
    }
    public String [][] findBestMove(String board[][],CastlingChecker cstChecker,int h) {
    ...
    public void makeMove(String board[][],CastlingChecker cstChecker,Cell move1,Cell move2) {
