    ...
    public void drawBoard() {
        ...
        for(int i=0;i<8;i++) {
            for(int j=0;j<8;j++) {
                ...
                int a=i+j;
                if((a%2)==0) {
                    data.boardView[i+1][j+1].setStyle("-fx-background-color: #a47c5c;");
                }
                else {
                    data.boardView[i+1][j+1].setStyle("-fx-background-color: #ecccac;");
                }
    ...
    public void updateBoard() {
        for(int i=1;i<=8;i++) {
            for(int j=1;j<=8;j++) {
                ...
                if((a%2)==0) {
                    data.boardView[i][j].setStyle("-fx-background-color: #a47c5c;");
                }
                else {
                    data.boardView[i][j].setStyle("-fx-background-color: #ecccac;");
                }
